---
title: iconify.yaml Configuration Reference
description: Complete reference for all configuration fields in the iconify.yaml file used by the Iconify SDK CLI and builder.
---

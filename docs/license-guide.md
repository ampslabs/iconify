...
This document classifies Iconify collections based on their licensing requirements. Use this guide to configure your `license_policy` in `iconify.yaml`.

## 1. Safe Collections (No Attribution Required)

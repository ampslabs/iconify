...
This document defines the normalized internal schema used by `iconify_sdk_core` to represent icon collections and individual icons. This schema is a subset of Iconify's JSON format, optimized for the Dart SDK.
